...
CREATE INDEX IF NOT EXISTS idx_members_last_name_lower ON public.members (LOWER(last_name) varchar_pattern_ops);
CREATE INDEX IF NOT EXISTS idx_members_first_name_lower ON public.members (LOWER(first_name) varchar_pattern_ops);
