...
package com.gaestalt.contact.grpc;

import com.gaestalt.contact.dto.ContactSearchResult;
...
import com.gaestalt.contact.entity.ContactLookup;
import com.gaestalt.contact.entity.ContactPendingAction;
import com.gaestalt.contact.entity.ContactPhone;
import com.gaestalt.contact.entity.StreetAddress;
import com.gaestalt.contact.repository.ContactLookupRepository;
import com.gaestalt.contact.repository.ContactPendingActionRepository;
import com.gaestalt.contact.repository.ContactRepository;
import com.gaestalt.contact.repository.ContactSearchJdbcRepository;
import com.gaestalt.contact.entity.ContactContract;
import com.gaestalt.contact.entity.Contract;
import com.gaestalt.contact.service.ContactAddressService;
import com.gaestalt.contact.service.ContactEmailService;
import com.gaestalt.contact.service.ContactPartitionContext;
import com.gaestalt.contact.service.ContactPhoneService;
import com.gaestalt.contact.service.ContactContractService;
import com.gaestalt.contact.service.BulkContactService;
import com.gaestalt.contact.service.ContactSearchService;
import com.gaestalt.contact.service.PartitionAssignmentService;
import com.gaestalt.contact.service.PendingActionEventPublisher;
import com.gaestalt.contact.service.ContractService;
...
public class ContactServiceImpl extends ContactServiceGrpc.ContactServiceImplBase {
    ...
    public void addAddress(AddAddressRequest request,
        ...
        try {
            com.gaestalt.contact.entity.AddressKind addressType = mapAddressType(request.getAddressType());
    ...
    private com.gaestalt.contact.entity.AddressKind mapAddressType(AddressType grpcType) {
        return switch (grpcType) {
            case HOME -> com.gaestalt.contact.entity.AddressKind.HOME;
            case BUSINESS -> com.gaestalt.contact.entity.AddressKind.BUSINESS;
            case MAILING -> com.gaestalt.contact.entity.AddressKind.MAILING;
            default -> throw new IllegalArgumentException("Invalid address type: " + grpcType);
        };
    }

    private AddressType mapToGrpcAddressType(com.gaestalt.contact.entity.AddressKind entityType) {
    ...
    private ContactAddressDetails buildAddressDetails(StreetAddress address) {
        ...
        if (address.getAddressLines() != null) {
            for (com.gaestalt.contact.entity.AddressLine line : address.getAddressLines()) {
    ...
    public void addEmail(AddEmailRequest request,
        ...
        try {
            com.gaestalt.contact.entity.AddressKind emailType = mapEmailType(request.getEmailType());
    ...
    public void addPhone(AddPhoneRequest request,
        ...
        try {
            com.gaestalt.contact.entity.AddressKind phoneType = mapPhoneType(request.getPhoneType());
    ...
    private com.gaestalt.contact.entity.AddressKind mapEmailType(EmailType grpcType) {
        return switch (grpcType) {
            case EMAIL_HOME -> com.gaestalt.contact.entity.AddressKind.HOME;
            case EMAIL_BUSINESS -> com.gaestalt.contact.entity.AddressKind.BUSINESS;
            case EMAIL_MAILING -> com.gaestalt.contact.entity.AddressKind.MAILING;
            default -> throw new IllegalArgumentException("Invalid email type: " + grpcType);
        };
    }

    private EmailType mapToGrpcEmailType(com.gaestalt.contact.entity.AddressKind entityType) {
        return switch (entityType) {
    ...
    private com.gaestalt.contact.entity.AddressKind mapPhoneType(PhoneType grpcType) {
        return switch (grpcType) {
            case PHONE_HOME -> com.gaestalt.contact.entity.AddressKind.HOME;
            case PHONE_BUSINESS -> com.gaestalt.contact.entity.AddressKind.BUSINESS;
            case PHONE_MAILING -> com.gaestalt.contact.entity.AddressKind.MAILING;
            default -> throw new IllegalArgumentException("Invalid phone type: " + grpcType);
        };
    }

    private PhoneType mapToGrpcPhoneType(com.gaestalt.contact.entity.AddressKind entityType) {
        return switch (entityType) {
    ...
    public void getContactByAlternateId(GetContactByAlternateIdRequest request,
        ...
        String idType = com.gaestalt.contact.validation.AlternateIdTypeValidator.resolveAndValidate(request.getType());
    ...
    public void hasPendingAction(HasPendingActionRequest request,
        ...
        try {
            ...
            com.gaestalt.contact.entity.PendingActionType actionType = mapPendingActionType(request.getActionType());
    ...
    private com.gaestalt.contact.entity.PendingActionType mapPendingActionType(PendingActionType grpcType) {
        return switch (grpcType) {
            case GENERATE_EXTERNAL_IDENTIFIERS -> com.gaestalt.contact.entity.PendingActionType.GENERATE_EXTERNAL_IDENTIFIERS;
        ...
        try {
            ...
            if (!request.getSkipGenerateExternalIdentifiers()) {
                ContactPendingAction action = ContactPendingAction.builder()
                        .contact(contact)
                        .actionType(com.gaestalt.contact.entity.PendingActionType.GENERATE_EXTERNAL_IDENTIFIERS)
                        .build();
                contactPendingActionRepository.save(action);
                pendingActionEventPublisher.publishPendingAction(
                        contact.getId(),
                        com.gaestalt.contact.entity.PendingActionType.GENERATE_EXTERNAL_IDENTIFIERS);
            }
